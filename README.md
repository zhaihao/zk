# zk [![CI][ciImg]][ciLink] [![VERSION][versionImg]][versionLink] [![STEWARD][stewardImg]][stewardLink] [![License][licenseImg]][licenseLink]

scala zk client

[ciImg]: https://github.com/zhaihao/zk/actions/workflows/ci.yml/badge.svg
